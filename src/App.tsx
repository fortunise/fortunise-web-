  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        {/* Fixed Logo with Subtle Light Background in Top Left Corner */}
        <header className="fixed top-6 left-6 z-50">
          <div className="relative group">
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent px-4 py-2 rounded-xl backdrop-blur-sm bg-gradient-to-br from-white/40 to-blue-50/30 shadow-sm">
              Fortunise
            </h1>
          </div>
        </header>
        ...
        <section 
          ...
          style={{
            backgroundImage: 'url(/assets/hero-business-consultancy.jpg)',
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            backgroundRepeat: 'no-repeat'
          }}
        >
          {/* Lighter overlay for better logo contrast */}
          <div className="absolute inset-0 bg-gradient-to-br from-white/85 via-blue-50/80 to-indigo-50/85"></div>
          ...
          <div className="relative max-w-7xl mx-auto text-center z-10">
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-900 via-indigo-900 to-purple-900 bg-clip-text text-transparent animate-in fade-in slide-in-from-bottom-4 duration-1000">
              Transform Your Business Vision Into Reality
            </h2>
            <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-150">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white text-lg px-8 py-6 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-105"
        ...
        <section 
          ...
          style={{
            backgroundImage: 'url(/assets/services-pattern-background.jpg)',
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            backgroundRepeat: 'no-repeat'
          }}
          ...
          <div className="relative max-w-7xl mx-auto z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <Card 
                  key={index} 
                  className="hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 hover:border-blue-300 bg-white/90 backdrop-blur-sm"
                >
                  <CardHeader>
                    <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center mb-4 shadow-lg" aria-hidden="true">
            ...
            <div className="text-center mt-12">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-lg px-8 py-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
                onClick={() => window.open(calendlyLink, '_blank')}
        ...
        {/* Funding Programs Section with Gradient Background */}
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-50 overflow-hidden">
        ...
        <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {/* Main Pricing Card */}
              <Card className="relative border-2 border-blue-500 shadow-2xl hover:shadow-3xl transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent className="space-y-6">
                  <div className="text-center">
                    <div className="flex items-center justify-center space-x-3 mb-2">
                      ...
                      <span className="text-5xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">$3,000</span>
                    </div>
                  ...
                  <Button 
                    size="lg" 
                    className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-lg py-6 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
                    onClick={() => window.open(calendlyLink, '_blank')}
              ...
              <Card className="border-2 hover:border-blue-300 transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1">
                <CardHeader>
                ...
                <CardContent className="space-y-6">
                  ...
                  <Button 
                    size="lg" 
                    variant="outline"
                    className="w-full border-2 border-blue-600 text-blue-600 hover:bg-blue-50 text-lg py-6 shadow-lg hover:shadow-xl transition-all duration-300"
                    onClick={() => window.open(calendlyLink, '_blank')}
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-slate-50 via-blue-50/30 to-white overflow-hidden relative">
          {/* Decorative elements */}
          ...
          <div className="relative max-w-7xl mx-auto z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {businessPlanComponents.map((component, index) => (
                <article 
                  key={index} 
                  className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-2 border-transparent hover:border-blue-300"
                >
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0">
                      <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center shadow-md" aria-hidden="true">
        ...
        <section 
          ...
          className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden"
          style={{
            backgroundImage: 'url(/assets/team-collaboration-background.jpg)',
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            backgroundRepeat: 'no-repeat'
          }}
        ...
        {/* Testimonials Section with Financial Background */}
        <section 
          id="testimonials" 
          className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden"
          style={{
            backgroundImage: 'url(/assets/financial-growth-background.jpg)',
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            backgroundRepeat: 'no-repeat'
          }}
          ...
          <div className="relative max-w-7xl mx-auto z-10">
            ...
            <div className="relative max-w-4xl mx-auto">
                ...
                >
                  {testimonials.map((testimonial, index) => (
                    <div key={index} className="w-full flex-shrink-0 px-4">
                      <Card className="shadow-2xl border-2 border-blue-200 bg-white/90 backdrop-blur-sm">
              ...
              <button
                ...
                className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-white rounded-full p-3 shadow-xl hover:shadow-2xl hover:bg-blue-50 transition-all duration-300 border-2 border-blue-200"
              ...
              <button
                ...
                className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-white rounded-full p-3 shadow-xl hover:shadow-2xl hover:bg-blue-50 transition-all duration-300 border-2 border-blue-200"
        ...
        <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
              ...
              <Card className="p-8 bg-gradient-to-br from-blue-600 to-indigo-600 text-white border-0 shadow-2xl hover:shadow-3xl transition-all duration-300">
                <CardHeader className="p-0 mb-6">
                ...
                <CardContent className="p-0">
                  ...
                  <Button 
                    size="lg" 
                    className="w-full bg-white text-blue-600 hover:bg-blue-50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
                    onClick={() => window.open(calendlyLink, '_blank')}
                    aria-label="Schedule a free consultation"
                  >
                    Schedule Free Consultation
        ...
        {/* Footer */}
        <footer className="bg-gradient-to-b from-gray-900 to-gray-950 text-white py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
